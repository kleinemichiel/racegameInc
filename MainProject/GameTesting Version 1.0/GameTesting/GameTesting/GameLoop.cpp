...
#include "GameLoop.h"
 ...
 void arrayShifter(uint8_t posOfObject, MY_USART serial){
	 ...
	 if((posOfObject * object1PreGen + 2) > 118){
		  ...
		  if(posOfObject == 0){
			  ...
			  serial.sendString("old obj 0: \n");
			  serial.sendString("posX obj 0: ");
			  serial.sendInt(object[0].posX);
			  serial.sendString("posY obj 0: ");
			  serial.sendInt(object[0].posY);
			  object1PreGen++;
			  object[posOfObject] = preGenObjects[1 * object1PreGen + 3];
			  serial.sendString("new obj 0: \n");
			  serial.sendString("posX obj 0: ");
			  serial.sendInt(object[0].posX);
			  serial.sendString("posY obj 0: ");
			  serial.sendInt(object[0].posY);
		  } else if(posOfObject == 1){
			   serial.sendString("old obj 1: \n");
			   serial.sendString("posX obj 1: ");
			   serial.sendInt(object[1].posX);
			   serial.sendString("posY obj 1: ");
			   serial.sendInt(object[1].posY);
			  object2PreGen++;
			  object[posOfObject] = preGenObjects[2 * object2PreGen + 2];
			   serial.sendString("new obj 1: \n");
			   serial.sendString("posX obj 1: ");
			   serial.sendInt(object[1].posX);
			   serial.sendString("posY obj 1: ");
			   serial.sendInt(object[1].posY);
		  } else if(posOfObject == 2){
			  serial.sendString("old obj 2: \n");
			  serial.sendString("posX obj 2: ");
			  serial.sendInt(object[2].posX);
			  serial.sendString("posY obj 2: ");
			  serial.sendInt(object[2].posY);
			  object3PreGen++;
			  object[posOfObject] = preGenObjects[3 * object3PreGen + 5];
			   serial.sendString("new obj 2: \n");
			   serial.sendString("posX obj 2: ");
			   serial.sendInt(object[2].posX);
			   serial.sendString("posY obj 2: ");
			   serial.sendInt(object[2].posY);
 ...
 void showGenObjects(MI0283QT9 lcd, MY_USART serial){
	 ...
	 if(object[1].type == 1){
		 ...
		 if(posYobj2 < 128){
			 ...
			 drawTruck(lcd, serial, object[1].posX, posYobj2, rgbcolor);
			 object[1].posY = posYobj2;
		 }
	 }
